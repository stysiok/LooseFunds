...
//     private readonly ILogger<KrakenHttpClientTests> _logger;
//     private readonly IPrivateRequestSigner _signer;
//
//     public KrakenHttpClientTests(HttpClient client, IPrivateRequestSigner signer, IOptions<KrakenOptions> options,
//         IOptions<KrakenCredentials> credentials, ILogger<KrakenHttpClientTests> logger)
//     {
//         _client = client;
//         _signer = signer;
//         _logger = logger;
