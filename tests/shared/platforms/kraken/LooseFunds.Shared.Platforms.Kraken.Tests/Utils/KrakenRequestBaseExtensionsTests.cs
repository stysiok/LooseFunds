...
public class KrakenRequestBaseExtensionsTests
{
    ...
    {
        //Arrange
        var addOrderRequest = new AddOrder(OrderType.limit, Type.buy, 10m, Pair.XXBTZEUR) { Nonce = 123321 };
        const string expected = "nonce=123321&ordertype=limit&pair=XXBTZEUR&type=buy&volume=10";
